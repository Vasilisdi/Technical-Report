...
{
Some typical applications that use vibration analysis implementations are turbine motors and shafts, motors connected pumps and motors connected to roller equipment among others.
}

\section{Fundamentals of Bearing Fault Frequencies}
{
The most significant challenge that the authors had to deal with is that of the faulty cases
detection. For this reason, fault and unfault models have been developed, and series of com
parisons between the actual model generated by apparatus measurements and these two sit
uational models are being executed. This development constitutes a real challenge since this
is the main criterion that identifies the state of the motor.
