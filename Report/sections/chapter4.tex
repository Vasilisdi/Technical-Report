...
\subsection{The Raspberry Pi 4 Algorithm} 
{
	...
	When the ADXL335 is powered with a 5\,V supply, each axis outputs an analog voltage centered at about 
	\(2.5\,\text{V}\) when experiencing \(0\,g\) (no acceleration). The sensitivity in this case is approximately 
	\(300\,\text{mV}/g\), meaning the output shifts by \(0.3\,\text{V}\) for every \(\pm 1\,g\) of acceleration 
	...
	\[
	V = \text{raw} \times \frac{5.0}{1023.0}.
	\]
	
	Then, subtract the zero-g bias (\(2.5\,\text{V}\)) and divide by the sensitivity (\(0.300\)) to convert to g-units:
	
	\[
	a_g = \frac{V - 2.5}{0.300}.
	\]
