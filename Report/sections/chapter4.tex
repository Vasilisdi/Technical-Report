...
\subsection{Vercel coding}
{
	...
	You can control access by configuring Vercel's authentication settings to restrict the deployment URL to only specific email addresses, ensuring your sensor data remains private while being easily accessible to authorized viewers.
